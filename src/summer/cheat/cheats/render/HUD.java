...
public class HUD extends Cheats {
    ...
    public void onRender2D(EventRender2D e) {
        if (!mc.gameSettings.showDebugInfo) {
            ...
            double currSpeed = Math.sqrt(Minecraft.getMinecraft().thePlayer.motionX * Minecraft.getMinecraft().thePlayer.motionX + Minecraft.getMinecraft().thePlayer.motionZ * Minecraft.getMinecraft().thePlayer.motionZ);
            float h = this.hue;
