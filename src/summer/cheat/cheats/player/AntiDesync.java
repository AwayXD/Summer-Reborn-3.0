...
public class AntiDesync extends Cheats {
    ...
    public void onUpdate(EventUpdate eu) {
        if (eu.isPre() && this.lastSlot != -1 && this.lastSlot != Minecraft.getMinecraft().thePlayer.inventory.currentItem)
            Minecraft.getMinecraft().thePlayer.sendQueue
                    .addToSendQueue(new C09PacketHeldItemChange(Minecraft.getMinecraft().thePlayer.inventory.currentItem));
    }
