            ...
            if (e.isPre()) {
                ...
                if (e.getHeightStepped() > 0.6) {
                    for (double offset : offsets) {
                        mc.getNetHandler()
                                .addToSendQueueNoEvent(new C03PacketPlayer.C04PacketPlayerPosition(Minecraft.getMinecraft().thePlayer.posX,
                                        Minecraft.getMinecraft().thePlayer.posY + offset * e.getHeightStepped(), Minecraft.getMinecraft().thePlayer.posZ, Minecraft.getMinecraft().thePlayer.onGround));
                    }
