...
public class Flight extends Cheats {
   ...
   // private Setting zoom;
                ...
                if (Minecraft.getMinecraft().thePlayer.onGround) {
                    if ((Minecraft.getMinecraft().thePlayer.isCollidedVertically)) {
                        if (Minecraft.getMinecraft().thePlayer.isPotionActive(Potion.jump)) {
                            motionY += (Minecraft.getMinecraft().thePlayer.getActivePotionEffect(Potion.jump).getAmplifier() + 1) * 0.1f;
                        }
    ...
    public void onUpdate(final EventUpdate e) {
        ...
        Minecraft.getMinecraft().thePlayer.stepHeight = 0f;
        this.mode = flyType.getValString();

        Minecraft.getMinecraft().thePlayer.cameraYaw = 0.00f;
        ...
        if (Minecraft.getMinecraft().thePlayer.hurtTime > 3)
            damaged = true;
        ...
        if (e.isPre()) {
            if (this.mode.equalsIgnoreCase("HypixelDamage")) {
                ++this.counter;
                if (this.counter == 1) {
                    Minecraft.getMinecraft().thePlayer.setPosition(Minecraft.getMinecraft().thePlayer.posX, Minecraft.getMinecraft().thePlayer.posY + 8.0E-6, Minecraft.getMinecraft().thePlayer.posZ);
                ...
                final double xDist = Minecraft.getMinecraft().thePlayer.posX - Minecraft.getMinecraft().thePlayer.prevPosX;
                final double zDist = Minecraft.getMinecraft().thePlayer.posZ - Minecraft.getMinecraft().thePlayer.prevPosZ;
                ...
                if (this.canboost && this.hypixelboost) {
                    ...
                    if (this.timer.hasReached(2000.0)) {
                        this.canboost = false;
                        Minecraft.getMinecraft().thePlayer.cameraYaw = 0.105f;
                    }
                }
                ...
                Minecraft.getMinecraft().thePlayer.motionY = -0.019999999552965164;
...
//         if (timer.hasReached(100)){ mc.thePlayer.jump(); timer.reset(); }
        ...
        if (this.mode.equalsIgnoreCase("Vanilla")) {
            ...
            Minecraft.getMinecraft().thePlayer.motionY = 0.085;
            Minecraft.getMinecraft().thePlayer.jumpMovementFactor = 2.0f;
            if (mc.gameSettings.keyBindJump.isKeyDown()) {
            ...
            if (this.level != 1 || (Minecraft.getMinecraft().thePlayer.moveForward == 0.0f && Minecraft.getMinecraft().thePlayer.moveStrafing == 0.0f)) {
                if (this.level == 2) {
                    this.level = 3;
                    ...
                    if (Minecraft.theWorld
                            .getCollidingBoundingBoxes(Minecraft.thePlayer,
                                    Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().offset(0.0, Minecraft.getMinecraft().thePlayer.motionY, 0.0))
                ...
                this.level = 2;
                final double boost = Minecraft.getMinecraft().thePlayer.isPotionActive(Potion.moveSpeed) ? 1.706 : 2.034;
