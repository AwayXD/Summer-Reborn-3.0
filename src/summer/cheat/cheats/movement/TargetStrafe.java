...
public class TargetStrafe extends Cheats {
    ...
    public void onUpdate(EventUpdate eu) {
        if (Minecraft.getMinecraft().thePlayer.isCollidedHorizontally && this.switchTimer.hasReached(200L)) {
    ...
    public void strafe(EventMotion e, double moveSpeed) {
        ...
        double dist = Minecraft.getMinecraft().thePlayer.getDistanceToEntity((Entity) KillAura.target);
